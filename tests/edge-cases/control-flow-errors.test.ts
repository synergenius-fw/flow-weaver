...
describe('Edge Cases: Control Flow and Error Handling', () => {
  ...
  describe('Error Propagation', () => {
    it('should throw error for negative input', async () => {
      ...
      await expect(
        validateAndDouble(true, { input: -5 }, testHelpers.createRuntime('validateAndDouble')),
    ...
    it('should throw error for input exceeding 100', async () => {
      ...
      await expect(
        validateAndDouble(true, { input: 101 }, testHelpers.createRuntime('validateAndDouble')),
    ...
    it('should succeed at boundary value (100)', async () => {
      ...
      const result = await validateAndDouble(true, { input: 100 }, testHelpers.createRuntime('validateAndDouble'));
    ...
    it('should succeed at boundary value (0)', async () => {
      ...
      const result = await validateAndDouble(true, { input: 0 }, testHelpers.createRuntime('validateAndDouble'));
