...
export const isolatedTestFiles: readonly string[] = [
  ...
  'tests/unit/cli-ai-credentials.test.ts',
  'tests/unit/cli-apikey.test.ts',
  'tests/unit/cli-credentials.test.ts',
  'tests/unit/cli-deploy.test.ts',
  'tests/unit/cli-export-coverage-2.test.ts',
  'tests/unit/cli-helpers-close.test.ts',
  'tests/unit/cli-helpers-tty.test.ts',
  'tests/unit/cli-helpers.test.ts',
  ...
  'tests/unit/mcp/mcp-dx-improvements.test.ts',
  ...
  'tests/unit/mcp/tools-model-compilable.test.ts',
  'tests/unit/mcp/tools-model.test.ts',
  'tests/unit/mcp/tools-pattern.test.ts',
