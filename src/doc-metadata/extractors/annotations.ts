...
defaultValue   ::= IDENTIFIER | INTEGER | STRING`,
    examples: [
      ...
      '@input name - Short Label         the dash text is the port label (1-2 words), shown in the diagram badge',
    ],
    contexts: ['nodeType'],
  },
  {
...
targetType     ::= "string" | "number" | "boolean" | "json" | "object"`,
  ...
  },
  {
    ...
    description:
      'Declares an event or cron trigger for the workflow. Can specify event, cron, or both.',
  ...
  },
  {
    ...
    description:
      'Cancels a running workflow execution when a specified event is received.',
  ...
  },
  {
    ...
    syntax: '@retries N',
    description:
      'Sets the retry count for the deployed function.',
