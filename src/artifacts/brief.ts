 ...
 *   its failure goes, and the edges that touch it light up. Light and dark, a
 *   print button.
...
function renderInteractive(ast: TWorkflowAST, g: Gathered, options: BriefOptions): string {
  ...
  const tabs = [
    ...
    ...(p.gates ? [['gates', `People and agents: ${g.gates.length}`, p.gates]] : []),
...
<body><div class="page">
  ...
  <div class="stage">
    ...
    <div class="split" id="split" title="Drag to resize, or double-click to reset"></div>
    <aside class="tray">
