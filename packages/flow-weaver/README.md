...
[![License: Elastic-2.0](https://img.shields.io/badge/License-ELv2-blue.svg)](./LICENSE)
...
Elastic License 2.0 (ELv2). See [LICENSE](./LICENSE) for full terms.

- **Free** for individuals and organizations with 15 or fewer people
- **Commercial license required** for organizations with more than 15 people — contact support@synergenius.pt
- **Output is unrestricted** — compiled workflows, generated code, and deployment artifacts are yours to use however you want
- **Cannot** be provided as a hosted/managed service to third parties
